...
# ========================
app = FastAPI(title="People Counting API - LOCAL", version="1.0.0")

# CORS untuk local development - allow localhost
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:3000",
...
print("✓ Models loaded successfully for LOCAL")
...
async def root():
    """Root endpoint"""
    return {
        "message": "People Counting API - LOCAL DEVELOPMENT",
        "version": "1.0.0",
        "environment": "local",
        "endpoints": {
            "health": "/api/health",
